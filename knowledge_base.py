...
g.add( (hasSubject, RDF.type, RDF.Property) )
g.add( (hasSubject, RDFS.label, Literal("hasSubject", lang="en")) )
g.add( (hasSubject, RDFS.comment, Literal("Course has a subject")) )
g.add( (hasSubject, RDFS.domain, Course) )
g.add( (hasSubject, RDFS.range, XSD.string) )

g.add( (hasNumber, RDF.type, RDF.Property) )
g.add( (hasNumber, RDFS.label, Literal("hasNumber", lang="en")) )
g.add( (hasNumber, RDFS.comment, Literal("Course has a number")) )
g.add( (hasNumber, RDFS.domain, Course) )
g.add( (hasNumber, RDFS.range, XSD.integer) )

g.add( (hasDescription, RDF.type, RDF.Property) )
g.add( (hasDescription, RDFS.label, Literal("hasDescription", lang="en")) )
g.add( (hasDescription, RDFS.comment, Literal("Course has a description")) )
g.add( (hasDescription, RDFS.domain, Course) )
